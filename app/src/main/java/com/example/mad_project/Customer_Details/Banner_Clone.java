...
public class Banner_Clone extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (deliveryDate.isEmpty() || getType.isEmpty()) {
                    Toast.makeText(Banner_Clone.this, "Please Fill all text feild.", Toast.LENGTH_SHORT).show();
                }
                else{
